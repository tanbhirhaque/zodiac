# 🌐 24/7 Free Cloud Hosting Guide: Dead Lead Society Bot

এই গাইডটি অনুসরণ করে আপনি আপনার **Dead Lead Society Bot**-টিকে কোনো খরচ ছাড়াই (**১০০% ফ্রি**) ক্লাউডে ২৪ ঘণ্টা চালু রাখতে পারবেন—এমনকি আপনার কম্পিউটার বন্ধ বা স্লিপে থাকলেও বটটি ডিসকর্ডে সবসময় অনলাইন থাকবে এবং নির্ধারিত সময়ে (সকাল ৯টা ও সন্ধ্যা ৭টায়) স্বয়ংক্রিয়ভাবে কাজ করবে।
...
1. এটি ক্লাউডে রান করার পর একটি পাবলিক লিংক তৈরি করে (যেমন: `https://dead-lead-society-bot.onrender.com/health`)।
